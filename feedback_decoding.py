...
def train():
	...
	model.load_state_dict(torch.load("feedback_complete.pt", map_location = device), strict = False)
...
def predict_new():
	...
	# for param in model1.parameters():
	# 	param.requires_grad = False
	# model1.load_state_dict(torch.load("mn_md_decoder.pt", map_location = device))

	model1 = RNN_arch_manual(1)
	model2 = RNN_arch_manual(1)
	...
	model.fc1.weight.data = model1.fc1.weight.data
	model.fc1.bias.data = model1.fc1.bias.data

	model.fc2.weight.data = model1.fc1.weight.data
	model.fc2.bias.data = model1.fc1.bias.data
